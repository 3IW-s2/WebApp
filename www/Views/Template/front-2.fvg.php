                ...
                <?php foreach ($menus as $menu) : ?>
                    ...
                    if ($hasSubmenu) : ?>
                        <li class="nav-item px-2 py-2 dropdown">
                            <a href="javascript:void(0)" class="nav-link text-uppercase text-dark dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><?= $menu['titre'] ?></a>
                    ...
                    <?php else : ?>
                        <li class="nav-item px-2 py-2">
                            <a class="nav-link text-uppercase text-dark" href="<?= $menu['url'] ?>"><?= $menu['titre'] ?></a>
                        </li>
                    <?php endif; ?>
                <?php endforeach; ?>
            </ul>
