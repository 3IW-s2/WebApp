...
class HistoryRepository
{
    ...
    public function addHistory( History $history)
    {
        $query = "INSERT INTO history (table_name, entity_type, entity_id, action, created_at, content)
                  VALUES (:table_name, :entity_type, :entity_id, :action, :created_at, :content)";
    ...
    {
        $query = "SELECT * FROM history WHERE table_name = :table_name AND entity_id = :entity_id ORDER BY created_at DESC";
